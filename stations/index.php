...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <a href="/tms/stations/add.php" class="btn-action btn-primary"><i class="fa fa-plus"></i> Add New Station</a>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/tms/stations/add.php?id=<?php echo $s['Station_ID']; ?>" class="btn-action btn-edit">Edit</a>
                    <a href="/tms/stations/delete.php?id=<?php echo $s['Station_ID']; ?>" class="btn-action btn-delete" onclick="return confirm('Are you sure you want to delete this station?');">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
